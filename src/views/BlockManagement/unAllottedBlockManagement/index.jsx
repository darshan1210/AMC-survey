...
import UnAllottedBlockListRow from 'shared/components/UnAllottedBlockListRow'

const UnAllottedBlockManagement = () => {
    ...
    const radios = [
        { name: 'UnAllotted Block - (50)', value: '1' },
    ];
...
export default UnAllottedBlockManagement
