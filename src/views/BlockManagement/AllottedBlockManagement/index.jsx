...
import AllottedBlockListRow from 'shared/components/AllottedBlockManagement'

const AllottedBlockManagement = () => {
...
export default AllottedBlockManagement
