...
function ResetPassword () {
  ...
  function onSubmit (data) {
    mutate({ sNewPassword: data.sNewPassword, sConfirmPassword: data?.sConfirmPassword, sAuthCode: data?.sAuthCode, token })
  }

  useEffect(() => {
    document.title = 'Reset Password'
  }, [])
const tempFals = false
  return (
                ...
                <InputGroup>
                  <Form.Control
                    ...
                    {...fields('sConfirmPassword', {
                      required: { value: true, message: validationErrors.confirmRequired },
