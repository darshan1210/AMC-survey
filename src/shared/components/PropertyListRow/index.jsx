...
const PropertyListRow = ({ user, index, }) => {
    ...
    const { control, watch, register, formState: { errors }, handleSubmit } = useForm({ mode: 'onSubmit' });
    ...
    return (
        <>
            ...
            <Modal show={isModal} onHide={() => setModal(false)} id='add-ticket' className='bigModal' size='lg'>
